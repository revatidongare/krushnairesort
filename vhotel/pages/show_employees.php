						...
						<div class="card">
							<div class="card-header">
							    <div style="float: right">
									 <a name="export_employee" href="export.php?export_employee" class=" m-2 p-2 btn btn-info btn-lg">Export To Excel</a> 
								</div>
...
<!--												<th><strong>Generate Id Card</strong></th>-->
												...
												<th><strong>Enter Feedback</strong></th>
...
<!--												<td class="text-left"><a href="generate_id.php?id=<?php echo $row['id']; ?>" class="btn btn-warning"><i class="fas fa-portrait " style="color: white;"></i></a></td>-->
												...
												<td class="text-center"><a href="enter_feedback.php?id=<?php echo $row['id'];?>" class="btn btn-info"><i class="fas fa-comments"></i></a></td>

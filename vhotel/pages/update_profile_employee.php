...
<head>
	...
	<title>
		<?php echo $hotel_name; ?> | Update Profile Picture
	</title>
						...
						<div class="card">
							...
							<div class="card-body">
								<form method="post" action="back.php" enctype="multipart/form-data">
									<div class="card-header">
										<h5 class="title">Upload Profile Picture</h5>
									</div>
									<div class="row">
										<div class="col-md-12">
									...
									<button class="btn btn-info btn-lg btn-block" type="submit" name="update_profile_image" value="">Update Details</button>
							</div>
							</form>
						</div>
					</div>

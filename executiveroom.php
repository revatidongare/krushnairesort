...
<head>
	...
	<title>Krushnai Resort  - Executive Room</title>
	<?php 
         $linum = 2;
         ?>
</head>
					...
					<div class=" col-lg-7 col-md-8 col-sm-12 col-xs-12 mx-auto detailspadding">
						<div id="carouselExampleControls1" class="carousel slide" data-ride="carousel">
							<div class="carousel-inner">
								...
								<div class="carousel-item">
									<img src="img/krushnai/rooms/kexecutive03.jpg" class="d-block w-100" alt="...">
								</div>
								<!-- <div class="carousel-item">
									<img src="img/metro/rooms/e3.jpg" class="d-block w-100" alt="...">
								</div> -->
							</div>
							...
							<div class="text">
								...
								<div class="row margintop20">
									<div class="col-lg-6 col-md-6" style="padding-left: 0px;">
										<a href="http://www.xmitter.com:4430/OnlineBooking/availability?propertyId=8a225b2645b465660145b64b22c60020" class="room-details-btn" id="room_details_1">
											Book Now
										</a>
									</div>
								</div>

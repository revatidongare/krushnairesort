...
<head>
	...
	<title>Krushnai - Royal Executive Room</title>
	<?php 
         $linum = 2;
         ?>
</head>
					...
					<div class=" col-lg-7 col-md-8 col-sm-12 col-xs-12 mx-auto detailspadding">
						<div id="carouselExampleControls3" class="carousel slide" data-ride="carousel">
							<div class="carousel-inner">
								...
								<div class="carousel-item">
									<img src="img/krushnai/rooms/r3.jpg" class="d-block w-100" alt="...">
								</div>
							</div>
					...
					<div class="col-lg-5 col-md-8 col-sm-12 col-xs-12">
						<div class="room-details-description-rooms-page">
							<div class="text">
								...
								<p align="justify" class="card-text" style="font-size: 15px;">These spacious rooms with the option of King or Twin beds. A well-appointed bathroom with select amenities ensures you have a convenient and comfortable stay.More amenities like tea & coffee maker, mini fridge, hygienic toiletries etc are also give to make your stay relaxing
								</p>
								<h5 class="card-title orangeheading">Amnities</h5>

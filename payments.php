...
<head>
  ...
  <title>Krushnai Resort - Payments</title>
  <?php
        $linum = 6;
     ?>
</head>
...
<body>
  ...
  <section class=" bg-img d-flex align-items-center justify-content-center mb-1 ;">
    <div class="bradcumbContent align-items-center">
      <!-- <h2>Payments</h2> -->
